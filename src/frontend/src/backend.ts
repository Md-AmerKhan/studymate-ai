...
export class Backend implements backendInterface {
    ...
    async getAllSessionIds(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSessionIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTimetable(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async saveMessage(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMessage(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveTimetable(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveTimetable(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
